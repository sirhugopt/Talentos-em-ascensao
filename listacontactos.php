  ...
  <div class="content-wrapper"style="background: linear-gradient(to bottom,#00008B, #4169E1);">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
          <h1 style="color: #FFFFFF;">Lista de Contactos</h1>          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Inicio</a></li>
              <li class="breadcrumb-item active"style="color: #FFFFFF;">Lista de Contactos</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
      ...
      <table class="table table-hover text-nowrap">
        <thead>
          <tr>
            ...
            <th style="color: #FFFFFF;">Mensagem</th>
            <th style="color: #FFFFFF;">Data</th>
            <th style="color: #FFFFFF;">Ações</th>
          </tr>
        </thead>
        <tbody>
        <?php foreach ($manager->listMensagensContato() as $mensagem):?>
    <tr>
      <td style="color: #FFFFFF;"><?= $mensagem['nome']?></td>
      <td style="color: #FFFFFF;"><?= $mensagem['email']?></td>
      <td style="color: #FFFFFF;"><?= $mensagem['titulo']?></td>
      <td style="color: #FFFFFF;"><?= $mensagem['mensagem']?></td>
      <td style="color: #FFFFFF;"><?= $mensagem['data_envio']?></td>
      <td class="text-center">
        <div class="btn-group" role="group">
          <a href="<?php echo 'https://mail.google.com/mail/?view=cm&fs=1&to='. urlencode($mensagem['email']). '&subject='. urlencode($mensagem['titulo']);?>" target="_blank" class="btn btn-custom-blue">
            <i class="fa fa-envelope"></i> Contactar
          </a>
          <button type="button" class="btn btn-custom-red" data-toggle="modal" data-target="#deleteModal<?= $mensagem['id']?>">
...
<?php foreach ($manager->listMensagensContato() as $mensagem):?>
<div class="modal fade" id="deleteModal<?= $mensagem['id']?>" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        Tem a certeza que deseja excluir a mensagem?
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancelar</button>
        <form method="POST" action="delete_contato.php">
