...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  if (isset($_FILES['imagem_produto']) && $_FILES['imagem_produto']['error'] === 0) {
      ...
      $uploadFile = $uploadDir . basename($imagem_produto);

      // Verifica se o arquivo foi enviado corretamente
      if (move_uploaded_file($_FILES['imagem_produto']['tmp_name'], $uploadFile)) {
          // Verifica se o arquivo foi enviado corretamente
          // Insira o sócio no banco de dados
          $manager->insertLoja("loja", [
              'imagem_produto' => $uploadFile,
      ...
      echo "Erro: Não foi possível uploadar o arquivo de imagem.";
  }
}
...
<?php endif; ?>
  ...
  <div class="content-wrapper"style="background: linear-gradient(to bottom,#00008B, #4169E1);">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
          <h1 style="color: #FFFFFF;">Registro de Produtos</h1>          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="index1.php">Início</a></li>
              <li class="breadcrumb-item active"style="color: #FFFFFF;">Registro de Produtos</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12">
      <h2 class="text-center text-white">Registrar Produto</h2>
              <form method="POST" action="" enctype="multipart/form-data">
          <div class="mb-3">
          <label for="imagem" style="color: #ffffff;">Imagem:</label>
                      <input type="file" class="form-control" name="imagem_produto" required>
          </div>

          <!-- Dados do produto -->
          <div class="mb-3">
            <label for="nome_produto" style="color: #ffffff;">Nome do Produto:</label>
            <input type="text" class="form-control" name="nome_produto" required>
          </div>

          <div class="mb-3">
            <label for="descricao" style="color: #ffffff;">Descrição:</label>
            <textarea class="form-control" name="descricao" rows="3" required></textarea>
          </div>

          <div class="mb-3">
            <label for="preco" style="color: #ffffff;">Preço:</label>
            <input type="number" class="form-control" name="preco" step="0.01" required>
          </div>

          <div class="mb-3">
            <label for="tamanho" style="color: #ffffff;">Tamanho:</label>
            <input type="text" class="form-control" name="tamanho" required>
          </div>

          <div class="mb-3">
            <label for="cor" style="color: #ffffff;">Cor:</label>
