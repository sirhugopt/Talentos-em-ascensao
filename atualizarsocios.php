...
<?php endif; ?>
  ...
  <div class="content-wrapper"style="background: linear-gradient(to bottom,#00008B, #4169E1);">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
          <h1 style="color: #FFFFFF;">Lista de Sócios</h1>          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="index1.php">Início</a></li>
              <li class="breadcrumb-item active"style="color: #FFFFFF;">Lista de Sócios</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
  ...
  <div class="container-fluid"style="background-color: #00008B;">
    ...
    <thead>
        <tr>
            <th style="min-width: 100px;color: #FFFFFF;">Nº Sócio</th>
            <th style="color: #FFFFFF;">Nome Completo</th>
            <th style="color: #FFFFFF;">Data de Nascimento</th>
            <th style="color: #FFFFFF;">Morada</th>
            <th style="color: #FFFFFF;">Código Postal</th>
            <th style="color: #FFFFFF;">Concelho</th>
            <th style="color: #FFFFFF;">Distrito</th>
            <th style="color: #FFFFFF;">Email</th>
            <th style="color: #FFFFFF;">Número de Telemóvel</th>
            <th style="color: #FFFFFF;">Género</th>
            <th style="color: #FFFFFF;">Ações</th>
        </tr>
    </thead>
    <tbody>
        <?php foreach ($manager->listSocio("socios") as $socio) :?>
            <tr>
                <td style="min-width: 100px;color: #FFFFFF;"><?= $socio['id_socio']?></td>
                <td style="color: #FFFFFF;"><?= $socio['nome_completo']?></td>
                <td style="color: #FFFFFF;"><?= date("d/m/Y", strtotime($socio['data_nascimento']));?></td>
                <td style="color: #FFFFFF;"><?= $socio['morada']?></td>
                <td style="color: #FFFFFF;"><?= $socio['codigopostal']?></td>
                <td style="color: #FFFFFF;"><?= $socio['concelho']?></td>
                <td style="color: #FFFFFF;"><?= $socio['distrito']?></td>

                <td style="color: #FFFFFF;"><?= $socio['email']?></td>
                <td style="color: #FFFFFF;"><?= $socio['numero_telemovel']?></td>
                <td style="color: #FFFFFF;"><?= $socio['sexualidade']?></td>
                <td class="text-center" style="color: #FFFFFF;">
                    <div class="btn-group" role="group">
                        <form method="POST" action="pageupdate.php" style="display:inline;">
                        ...
                        <form method="POST" action="delete_client.php" style="display:inline;">
                            <input type="hidden" name="id_socio" value="<?= $socio['id_socio']?>">
                            <button class="btn btn-custom-red" onclick="return confirm('Tem a certeza que deseja excluir?');">
